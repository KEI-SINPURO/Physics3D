// ==========================================
// 高校物理 2Dシミュレーションエンジン (高品質多機能・シミュレーション内公式なし版)
// ==========================================
...
function render() {
    ...
    try {
        ...
        // ----------------------------------------------------
            ...
            if(animType.includes("spring")) {
                ...
                if(animType.includes("friction")) {
                    ...
                    dA(0, 10, p, 10, '#3498db', 'F'); dA(0, 40, -p, 40, '#e67e22', animType.includes("friction_s")?'f':'f\'');
        ...
        // ----------------------------------------------------
            ...
            if(Math.sin(time*2)>0) dA(pw+20,0,pw+60,0,'#e74c3c','W');
        ...
        // ----------------------------------------------------
        ...
        else if (animType.includes("refract") || animType.includes("reflect") || animType.includes("slit") || animType.includes("diffraction") || animType.includes("light")) {
            ...
            if(!isTotal) { dAng(0, 0, 60, Math.PI/2 - aR, Math.PI/2, "r", "#2980b9"); dA(ix, iy, 0, iy, 'sin i', true); dA(rx, ry, 0, ry, 'sin r', true); }
        }
        // ----------------------------------------------------
        ...
        // ----------------------------------------------------
        ...
        else if (animType.includes("voltage") || animType.includes("circuit") || animType.includes("ohm") || animType.includes("kirchhoff") || animType.includes("joule") || animType.includes("electric")) {
            ...
            dLine(-15, 45, -15, 75, "#e74c3c", 4); dLine(15, 50, 15, 70, "#34495e", 4); 
            dMath("V", -5, 95);
            dB(0, -60, 50, 25, "#bdc3c7"); dMath("R", -5, -75);
            dA(-60, 0, -60, -30, "#e67e22", "I"); 
        }
        // ----------------------------------------------------
        ...
        // ----------------------------------------------------
            ...
            dA(0, 0, 0, vy, '#e74c3c', 'v_y', true); dA(0, 0, vx, 0, '#95a5a6', 'v_x', true); 
        ...
        else if (animType.includes("mag") || animType.includes("ampere") || animType.includes("ac_") || animType.includes("reactance") || animType.includes("impedance") || animType.includes("resonance")) {
        ...
        // ----------------------------------------------------
            ...
            dLine(-120, 50, 120, 50, "#7f8c8d", 20); dMath("Metal", -30, 80);
            dA(-80, -50, -20, 40, "#f1c40f", "光子");
            if(t % 2 > 0.5) dA(0, 40, 80, -20, "#3498db", "e⁻");
        }
        ...
        else if (animType.includes("compton") || animType.includes("decay") || animType.includes("mass") || animType.includes("matter") || animType.includes("modern")) {
            dC(0, 0, 40, "#e74c3c"); dMath("Δm", -15, 60);
            dA(50, 0, 120, 0, "#f1c40f", "Energy");
        }
        else {
