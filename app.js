// ==========================================
// 高校物理 2Dシミュレーションエンジン (第1回 力学編・修正版)
// ==========================================
...
function render() {
    ...
    try {
        ...
        // ----------------------------------------------------
        // 4. 運動量と力積 (momentum / collision) ※修正済み
        // ----------------------------------------------------
            ...
            // 等質量・完全弾性衝突の正しい動き
            if (t2 < 2.0) {
                x1 = -150 + 60 * t2; // m1が右へ進む
                x2 = 10;             // m2は静止
                v1 = 60;
                v2 = 0;
            } else {
                x1 = -30;            // m1は衝突して静止
                x2 = 10 + 60 * (t2 - 2.0); // m2が速度を受け継ぎ右へ進む
                v1 = 0;
                v2 = 60;
            }
